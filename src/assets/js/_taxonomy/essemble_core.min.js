...
function extend(t, e) {
    ...
    for (var s in i) e.prototype[s] = i[s];
...
function replaceXMLStr(t, e, i) {
    if ($(t).children().length > 0) return $(t).children().each(function() {
        var t = $(this).text().replace(e, i);
        $(this).text(t)
    }), t;
    var s = $(t).text().replace(e, i);
    return $(t).text(s), t
}
...
function PxLoaderImage(t, e, i) {
    ...
    var r = function() {
            "complete" === s.img.readyState && (l(), n.onLoad(s))
        },
        a = function() {
            l(), n.onLoad(s)
        },
        ...
        l = function() {
            s.unbind("load", a), s.unbind("readystatechange", r), s.unbind("error", o)
        };
    this.start = function(e) {
        n = e, s.bind("load", a), s.bind("readystatechange", r), s.bind("error", o), s.img.src = t
    }, this.checkStatus = function() {
        s.img.complete && (l(), n.onLoad(s))
    }, this.onTimeout = function() {
        l(), s.img.complete ? n.onLoad(s) : n.onTimeout(s)
    }, this.getName = function() {
        return t
    }, this.bind = function(t, e) {
        s.img.addEventListener ? s.img.addEventListener(t, e, !1) : s.img.attachEvent && s.img.attachEvent("on" + t, e)
    }, this.unbind = function(t, e) {
        s.img.removeEventListener ? s.img.removeEventListener(t, e, !1) : s.img.detachEvent && s.img.detachEvent("on" + t, e)
    }
}
    ...
    if (this._element = t.element, this._screen = t.element._screen, this._container = t.container, this._xml = t.xml, this._width = 0, this._height = 0, this._scroll = !1, this._element._width && (this._width = this._element._width), this._element._height && (this._height = this._element._height), xmlAttr(this._xml, "scroll") && (this._scroll = Boolean(-1 != this._xml.attr("scroll").toLowerCase().indexOf("true"))), this._xml.children().length > 0)
        for (var e = 0; e < this._xml.children().length; e++) {
            var i = this._xml.children()[e],
                s = t.element._elementLoader,
                n = new Element({
                    screen: this._screen,
                    xml: i
                });
            n._target = this._container, s.addElement(n)
        }
}
...
function ElementLoader(t) {
    ...
    this._loader.addProgressListener(function(t) {
        ...
        $(i._container).append(e)
    }), this._loader.addCompletionListener(function() {
        e.hidePreloader(), e._onLoadComplete && (e._onCompleteParams ? e._onCompleteScope[e._onLoadComplete](e._onCompleteParams) : e._onCompleteScope[e._onLoadComplete]());
        for (var t = 0; t < e._arElements.length; t++) e._arElements[t]._relativePos ? e.delayRelativePos(e._arElements[t]) : e.delayAnimate(e._arElements[t])
    })
}
...
null !== ua.match(/android 2\.[12]/) && (HTMLMediaElement.prototype.canPlayType = function(t) {
        ...
        load: function(t, e) {
            this._elementLoader && (this._elementLoader._arElements = null, this._elementLoader = null), this._container = t, e || this.unload(this._container), this._arEvents = [], this._xmlPath ? loadXML(this._xmlPath, this.loadXMLCompleteHandler.bind(this)) : alert("xml file has not been defined")
        },
        ...
        createEvents: function(t) {
            ...
            $(t).find("event").each(function() {
                ...
                var r = {};
                r._id = t, r._arRollovers = i, r._arRollouts = s, r._arClicks = n, e._arEvents.push(r)
            })
        },
        ...
        getElementById: function(t) {
            for (var e = null, i = this.getElementLoaderArray(), s = 0; s < i.length; s++)
                if (i[s]._id == t) {
                    e = i[s];
                    break
                }
        ...
        doClickEventById: function(t, e) {
            for (var i = t.split(","), s = 0; s < i.length; s++) {
                var t = i[s],
                    ...
                    a = n.getEventById(r);
                a && a._arClicks.length > 0 && n.fireEvents(a._arClicks, e)
            }
        },
        ...
        fireEvents: function(t, e) {
            for (var i = 0; i < t.length; i++) {
                ...
                switch (r[0].tagName) {
                    case "event":
                        for (var l = 0; l < o.length; l++) s = o[l], this.getScreen(s).doClickEventById(this.getElementId(s), e);
                        break;
                    case "css":
                        for (var h = r.attr("name").toString(), c = 0; c < o.length; c++) s = o[c], n = "this" == s ? e : this.getScreen(s).getElementById(this.getElementId(s)), $(n._container).removeClass(), $(n._container).addClass(h);
                        break;
                    case "url":
                    ...
                    case "anim":
                        for (var u = 0; u < o.length; u++) {
                            s = o[u], n = "this" == s ? e : this.getScreen(s).getElementById(this.getElementId(s));
                            var d = n._anim;
                            n._anim = r.attr("type"), n._animtime = r.attr("animtime"), n._animdelay = r.attr("animdelay"), n._animease = r.attr("ease"), n._animOnComplete = r.attr("animcomplete") || null, n.animate(), n._anim = d
                        }
                        break;
                    case "enable":
                        for (var p = 0; p < o.length; p++) s = o[p], n = "this" == s ? e : this.getScreen(s).getElementById(this.getElementId(s)), n.enable();
                        break;
                    case "disable":
                        for (var f = 0; f < o.length; f++) s = o[f], n = "this" == o[f] ? e : this.getScreen(s).getElementById(this.getElementId(s)), n.disable();
                        break;
                    case "function":
                        ...
                        if (-1 != g.indexOf(".")) {
                            var b = g.split(".");
                            if ("parent" == b[0].toLowerCase()) {
                                var E = this._screenElement;
                                E && (v = E.screen())
                            } else {
                                var y = this.getElementById(b[0]);
        ...
        searchForFunction: function(t, e) {
            for (var i = 0; i < this.getElementLoaderArray().length; i++) {
                var s = this.getElementLoaderArray()[i];
                if (s._custom && "function" == typeof s._custom[t]) {
                    e ? s._custom[t](e, this) : s._custom[t](this);
                    break
                }
            }
        ...
        showWord: function(t) {
            var e = this.getElementById("glossary");
            if (e) {
                var i = e._custom.getWordObjByWord(t);
                i && (e._custom.showWords(i.letter), e._custom.showDef(i))
            }
        }
    },
    function(t) {
        function e(t) {
            ...
            this.add = function(t) {
                t.tags = new i(t.tags), null == t.priority && (t.priority = 1 / 0), s.push({
                    resource: t,
                    status: a.QUEUED
                })
            ...
            var l = function(t) {
                t = o(t);
                var e = function(e) {
                    for (var i = e.resource, s = 1 / 0, n = 0; n < i.tags.length; n++)
                        for (var r = 0; r < Math.min(t.length, s) && !(i.tags.all[n] === t[r] && s > r && (s = r, 0 === s)) && 0 !== s; r++);
                    return s
                };
                return function(t, i) {
                    var s = e(t),
                        n = e(i);
                    return n > s ? -1 : s > n ? 1 : t.priority < i.priority ? -1 : t.priority > i.priority ? 1 : 0
                }
            };
            this.start = function(t) {
                if (0 == s.length) try {
                    listener = n[1], listener.callback({
                        completedCount: 0,
                        totalCount: 0
                    })
                } catch (i) {}
            ...
            var h = function() {
                for (var e = !1, i = Date.now() - r, n = i >= t.noProgressTimeout, o = i >= t.loggingDelay, l = 0, c = s.length; c > l; l++) {
                    var m = s[l];
                    m.status === a.WAITING && (m.resource.checkStatus && m.resource.checkStatus(), m.status === a.WAITING && (n ? m.resource.onTimeout() : e = !0))
                }
                o && e && _(), e && setTimeout(h, t.statusInterval)
            };
            this.isBusy = function() {
                for (var t = 0, e = s.length; e > t; t++)
                    if (s[t].status === a.QUEUED || s[t].status === a.WAITING) return !0;
                return !1
            };
            var c = function(t, e) {
                ...
                if (null != _ && _.status === a.WAITING)
                    for (_.status = e, r = Date.now(), l = t.tags.length, i = 0, o = n.length; o > i; i++) h = n[i], c = 0 === h.tags.length ? !0 : t.tags.intersects(h.tags), c && m(_, h)
            };
            ...
            var m = function(t, e) {
                    var i, n, r, o, l = 0,
                        h = 0;
                    for (i = 0, n = s.length; n > i; i++) r = s[i], o = !1, o = 0 === e.tags.length ? !0 : r.resource.tags.intersects(e.tags), o && (h++, (r.status === a.LOADED || r.status === a.ERROR || r.status === a.TIMEOUT) && l++);
                    e.callback({
                        resource: t.resource,
                    ...
                    if (window.console) {
                        ...
                        for (var n = 0, r = s.length; r > n; n++) {
                            ...
                            if (t || o.status === a.WAITING) {
                                var l = "PxLoader: #" + n + " " + o.resource.getName();
                                switch (o.status) {
                                    case a.QUEUED:
                                        l += " (Not Started)";
                                        break;
        ...
        var s = new PxLoaderImage(t, e, i);
        return this.add(s), s.img
        ...
        createDiv: function() {
            ...
            if ($(t).css("visibility", "hidden"), xmlAttrStr(this._xml, "margin") && $(t).css("margin", this._xml.attr("margin")), xmlAttrStr(this._xml, "margin-top") && $(t).css("margin-top", getUnit(this._xml.attr("margin-top"))), xmlAttrStr(this._xml, "margin-right") && $(t).css("margin-right", getUnit(this._xml.attr("margin-right"))), xmlAttrStr(this._xml, "margin-bottom") && $(t).css("margin-bottom", getUnit(this._xml.attr("margin-bottom"))), xmlAttrStr(this._xml, "margin-left") && $(t).css("margin-left", getUnit(this._xml.attr("margin-left"))), xmlAttrStr(this._xml, "min-width") && $(t).css("min-width", getUnit(this._xml.attr("min-width"))), xmlAttrStr(this._xml, "max-width") && $(t).css("max-width", getUnit(this._xml.attr("max-width"))), xmlAttrStr(this._xml, "min-height") && $(t).css("min-height", getUnit(this._xml.attr("min-height"))), xmlAttrStr(this._xml, "max-height") && $(t).css("max-height", getUnit(this._xml.attr("max-height"))), xmlAttrStr(this._xml, "z-index") && $(t).css("z-index", this._xml.attr("z-index")), xmlAttrStr(this._xml, "float") && $(t).css("float", this._xml.attr("float")), xmlAttrStr(this._xml, "clear") && $(t).css("clear", this._xml.attr("clear")), xmlAttrStr(this._xml, "display") && $(t).css("display", this._xml.attr("display")), xmlAttrStr(this._xml, "overflow") && $(t).css("overflow", this._xml.attr("overflow")), "image" != this._type && (xmlAttrStr(this._xml, "className") && $(t).addClass(this._xml.attr("className")), xmlAttrStr(this._xml, "class") && $(t).addClass(this._xml.attr("class"))), this._scroll) {
                var i = this._xml.attr("scroll").toLowerCase(),
                    s = -1 != i.indexOf("x"),
                    n = -1 != i.indexOf("y"); - 1 != i.indexOf("touch") ? supportsTouch && (s ? $(t).css("overflow-x", "auto") : n ? $(t).css("overflow-y", "auto") : ($(t).css("overflow-y", "auto"), $(t).css("overflow-x", "auto"))) : s ? ($(t).css("overflow-x", "auto"), $(t).css("overflow-y", "hidden")) : n ? ($(t).css("overflow-y", "auto"), $(t).css("overflow-x", "hidden")) : ($(t).css("overflow-y", "auto"), $(t).css("overflow-x", "auto")), $(t).css("-webkit-overflow-scrolling", "touch")
            }
            ...
            if (this._width) {
                var o = this._width;
                "match" === o.toString().toLowerCase() && a && (o = a._width), this._width = parseInt(o), $(t).css("width", this._width)
            }
            if (this._height) {
                var l = this._height;
                "match" === l.toString().toLowerCase() && a && (l = a._height), this._height = parseInt(l), $(t).css("height", this._height)
            }
        ...
        animate: function() {
            for (var t, e = this._anim.split("|"), i = 0; i < e.length; i++) {
                t = e[i];
                var s; - 1 != t.indexOf("top_") && (s = t.split("_")[1], -1 != s.toString().indexOf("+=") && (s = this._y + Number(s.toString().replace("+=", ""))), -1 != s.toString().indexOf("-=") && (s = this._y - Number(s.toString().replace("-=", ""))), -1 != s.toString().indexOf("orig") && (s = this._y), t = "moveTop");
                var n; - 1 != t.indexOf("left_") && (n = t.split("_")[1], -1 != n.toString().indexOf("+=") && (n = this._x + Number(n.replace("+=", ""))), -1 != n.toString().indexOf("-=") && (n = this._x - Number(n.replace("-=", ""))), -1 != n.toString().indexOf("orig") && (n = this._x), t = "moveLeft");
                var r;
                ...
                switch (t) {
                    ...
                    case "hide":
                        ...
                        $(this._container).stop(!0, !1).delay(1e3 * this._animdelay).animate(h, {
                            ...
                            easing: JQEase(this._animease),
                            complete: function() {
                                l.registerAnimComplete.bind(l), $(l._container).css("display", "none")
                            }
                        });
                        break;
                    case "alpha":
                    case "show":
                        ...
                        $(this._container).css("visibility", "visible"), $(this._container).css("display", "block"), $(this._container).css("opacity", 0), $(this._container).stop(!0, !1).delay(1e3 * this._animdelay).animate(h, {
                            duration: 1e3 * this._animtime,
                            easing: JQEase(this._animease),
                    ...
                    case "top":
                        ...
                        $(this._container).css("top", c), $(this._container).css("visibility", "visible"), $(this._container).css("display", "block"), $(this._container).stop(!0, !1).delay(1e3 * this._animdelay).animate(h, {
                            duration: 1e3 * this._animtime,
                            easing: JQEase(this._animease),
                            complete: this.registerAnimComplete.bind(this)
                        });
                    ...
                    case "left":
                        ...
                        $(this._container).css("left", c), $(this._container).css("visibility", "visible"), $(this._container).css("display", "block"), $(this._container).stop(!0, !1).delay(1e3 * this._animdelay).animate(h, {
                            duration: 1e3 * this._animtime,
                            easing: JQEase(this._animease),
                            complete: this.registerAnimComplete.bind(this)
                        });
                    ...
                    case "right":
                        ...
                        $(this._container).css("left", c), $(this._container).css("visibility", "visible"), $(this._container).css("display", "block"), $(this._container).delay(1e3 * this._animdelay).animate(h, {
                            duration: 1e3 * this._animtime,
                            easing: JQEase(this._animease),
                            complete: this.registerAnimComplete.bind(this)
                        });
                    ...
                    case "movetop":
                        ...
                        $(this._container).css("visibility", "visible"), $(this._container).css("display", "block"), $(this._container).stop(!0, !1).delay(1e3 * this._animdelay).animate(h, {
                            duration: 1e3 * this._animtime,
                            easing: JQEase(this._animease),
                            complete: this.registerAnimComplete.bind(this)
                        });
                    ...
                    case "drop":
                        ...
                        $(this._container).css("scale", 3), $(this._container).css("opacity", 0), $(this._container).css("visibility", "visible"), $(this._container).css("display", "block"), $(this._container).stop(!0, !1).delay(1e3 * this._animdelay).animate(h, {
                            duration: 1e3 * this._animtime,
                            easing: JQEase(this._animease),
                            complete: this.registerAnimComplete.bind(this)
                        });
                    ...
                    case "scaleup":
                        ...
                        $(this._container).css("scale", 0), $(this._container).css("opacity", 0), $(this._container).css("visibility", "visible"), $(this._container).css("display", "block"), $(this._container).stop(!0, !1).delay(1e3 * this._animdelay).animate(h, {
                            duration: 1e3 * this._animtime,
                            easing: JQEase(this._animease),
                            complete: this.registerAnimComplete.bind(this)
                        });
                        break;
                    default:
                        $(this._container).show(), $(this._container).css("display", "block"), $(this._container).css("visibility", "visible"), $(this._container).css("opacity", 1), this.registerAnimComplete()
                }
            }
        },
        registerEvents: function() {
            if ("disabled" != this._anim && "disable" != this._anim) {
                ...
                for (var r = 0; r < n.length; r++)
                    if (t = this._screen.getEventById(n[r])) {
                    ...
                    } else alert("event not found:" + n[r]);
        ...
        load: function() {
            ...
            for (var t = 0; t < this._arElements.length; t++) this._arElements[t]._container && (this._arElements[t]._container = null), this._arElements[t].create();
